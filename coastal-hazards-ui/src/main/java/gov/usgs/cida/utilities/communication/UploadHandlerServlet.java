...
public class UploadHandlerServlet extends HttpServlet {
    ...
    private static void sendResponse(HttpServletResponse response, String string) {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        ...
        String filename = request.getParameter(FILE_UPLOAD_FILENAME_PARAM_CONFIG_KEY);
        if (StringUtils.isBlank(filename)) {
            filename = FILE_UPLOAD_FILENAME_PARAM_DEFAULT;
        }
    }
//    @Override
//    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException {
