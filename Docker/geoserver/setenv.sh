...
export CATALINA_OPTS="$CATALINA_OPTS -Dcch_geoserver_http_port=${cch_geoserver_http_port}"
export CATALINA_OPTS="$CATALINA_OPTS -Dcch_geoserver_https_port=${cch_geoserver_https_port}"
