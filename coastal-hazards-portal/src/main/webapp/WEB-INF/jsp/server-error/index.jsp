...
<html lang="en">
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/webjars/bootstrap/${version.bootstrap}/css/bootstrap<%= development ? "" : ".min"%>.css" />
        <link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/webjars/font-awesome/${version.fontawesome}/css/font-awesome<%= development ? "" : ".min"%>.css" />
        <script type="text/javascript" src="<%=request.getContextPath()%>/webjars/jquery/${version.jquery}/jquery<%= development ? "" : ".min"%>.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath()%>/webjars/bootstrap/${version.bootstrap}/js/bootstrap<%= development ? "" : ".min"%>.js"></script>
