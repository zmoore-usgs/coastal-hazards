							...
							<div class="row">
								<div class='well well'>
									...
									<div id="container-control-button">
										...
										<form action="<%=baseUrl%>/ui/print/item/<%=item.getId() %>"><button type="submit" class="btn btn-default control-button" id="print-button" data-tooltip="tooltip" data-placement="right" title="Go To Print View">Print Snapshot</button></form>
