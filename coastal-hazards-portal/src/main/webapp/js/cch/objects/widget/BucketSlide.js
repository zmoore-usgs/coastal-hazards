...
CCH.Objects.Widget.BucketSlide = function (args) {
	...
	me.createCard = function (args) {
		...
		var item = args.item,
			...
			itemSummaryMedium = itemSummary.medium || {},
			title = itemSummaryMedium.title || 'Title Not Provided',
			...
			$downloadButton = $bottomControlRow.find('> button:nth-child(2)'),
			$infoButton = $bottomControlRow.find('> button:nth-child(3)'),
			$shareButton = $bottomControlRow.find('> button:nth-child(4)'),
