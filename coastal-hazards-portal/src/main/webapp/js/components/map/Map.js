...
CCH.Objects.Map = function (args) {
    ...
    return $.extend(me, {
        init: function () {
            ...
            me.getFeatureInfoControl.events.register("getfeatureinfo", this, function (evt) {
                ...
                if (features) {
                    ...
                    features.each(function (feature) {
                        ...
                        layers[id].push(feature.attributes);
                    });
                    
                    //Send a get to "data/sld/{id}" using "accept: application/json"
                    for (layer in layers) {
                            ...
                            $.ajax('data/sld/' + layer, {
                                ...
                                'headers': {          
                                 ...
                                 success : function (style) {
                                    ...
                                    // Average the CVI Risk
                                    averagedCviRisk = features.sum(function(f) {
                                        return parseInt(f.CVIRISK);
                                    }) / features.length;
                                 }, 
                                 error : function () {
                                     var a = 1;
