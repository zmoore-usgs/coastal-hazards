...
/**
 * Limitation is that it uses current time (in milliseconds) to get the id
 * This is not good for lots of items generated quickly, but should be alright for slow creation
