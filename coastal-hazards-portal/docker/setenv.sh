...
export CATALINA_OPTS="$CATALINA_OPTS -Dcch_csw_endpoint=http://$EXTERNAL_HOST:$PYCSW_PORT/csw"
export CATALINA_OPTS="$CATALINA_OPTS -Dcch_csw_internal_endpoint=http://$PYCSW_INTERNAL_HOST:$PYCSW_INTERNAL_PORT/csw"
export CATALINA_OPTS="$CATALINA_OPTS -Dcch_csw_external_endpoint=http://$EXTERNAL_HOST:$PYCSW_PORT/csw"
