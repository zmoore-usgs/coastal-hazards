...
export CATALINA_OPTS="$CATALINA_OPTS -Dcch_base_url=http://$PORTAL_HOST:$PORTAL_INTERNAL_HTTP_PORT/coastal-hazards-portal"
...
export CATALINA_OPTS="$CATALINA_OPTS -Dcch_geoserver_endpoint=http://$GEOSERVER_HOST:$GEOSERVER_PORT/geoserver"
export CATALINA_OPTS="$CATALINA_OPTS -Dcch_portal_geoserver_endpoint=http://$GEOSERVER_HOST:$GEOSERVER_PORT/geoserver"
export CATALINA_OPTS="$CATALINA_OPTS -Dcch_n52_endpoint=http://$N52_HOST:$N52_PORT/wps"
export CATALINA_OPTS="$CATALINA_OPTS -Dcch_csw_endpoint=http://$PYCSW_HOST:$PYCSW_PORT/csw"
export CATALINA_OPTS="$CATALINA_OPTS -Dcch_csw_internal_endpoint=http://$PYCSW_INTERNAL_HOST:$PYCSW_INTERNAL_PORT/csw"
export CATALINA_OPTS="$CATALINA_OPTS -Dcch_csw_external_endpoint=http://$PYCSW_HOST:$PYCSW_PORT/csw"
